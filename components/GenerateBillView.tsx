    ...
    <div className="bg-white min-h-full p-4 pb-24 rounded-lg shadow-sm">
      ...
      <div className="mb-6 bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
        ...
        <div className="mt-4 flex items-center justify-between gap-4">
          <div className="bg-white px-4 py-2 rounded-lg border border-blue-200 shadow-sm flex flex-col">
            <span className="text-[10px] text-gray-500 uppercase font-bold">Previous Reading</span>
            <strong className="text-2xl text-blue-700 font-mono">{tenant.lastReading}</strong>
          </div>
          <div className="text-right">
            <p className="text-xs text-gray-500">Rent Amount</p>
            <p className="font-bold text-gray-900 text-lg">{formatCurrency(tenant.rent)}</p>
          </div>
        </div>
      </div>
